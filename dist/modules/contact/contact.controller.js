...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Get all contact submissions (Admin only)" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: "Returns all contact submissions" }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.SUPER_ADMIN, user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: "Get contact submission by ID (Admin only)" }),
    (0, swagger_1.ApiParam)({ name: "id", description: "Submission ID" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: "Returns contact submission" }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.SUPER_ADMIN, user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: "Mark submission as read (Admin only)" }),
    (0, swagger_1.ApiParam)({ name: "id", description: "Submission ID" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: "Marked as read successfully" }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.SUPER_ADMIN, user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: "Respond to contact submission (Admin only)" }),
    (0, swagger_1.ApiParam)({ name: "id", description: "Submission ID" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: "Response sent successfully" }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.SUPER_ADMIN, user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: "Delete contact submission (Admin only)" }),
    (0, swagger_1.ApiParam)({ name: "id", description: "Submission ID" }),
